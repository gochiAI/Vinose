...
export const ChapterListPage = () => {
  ...
  const handleAddChapter = async () => {
    ...
    const newChapter: Chapter = {
      ...
      episodeCount: 0, // 必須
      sceneCount: 0, // 必須
      createdAt: now, // EntityBase で必須
      updatedAt: now, // EntityBase で必須
    };
    ...
    try {
      ...
      setNewChapterTitle("");
      navigate(`/chapters/${newChapterId}`);
    } catch (e) {
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400">
            Manage the story structure and progression.
          </p>
        </div>
        <button
          ...
          {chapters.map((chapter) => (
            ...
            >
              ...
              <div className="flex items-center gap-4">
                ...
                <button
                  className="p-2 text-gray-400 hover:text-white hover:bg-white/5 rounded-full z-10"
