                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-4 pt-4 border-t border-border">
                                 <h3 className="text-md font-semibold text-foreground">{t('serviceStatus', language)}</h3>
                                {/* AI Settings */}
                                <div className="space-y-1">
                                    <p className="text-sm font-medium text-foreground">{t('aiAssistant', language)}</p>
                                    {isAiAvailable ? (
                                        <>
                                            <p className="text-xs text-green-600 dark:text-green-400">{t('featureEnabled', language)}</p>
                                        </>
                                    ) : (
                                        <>
                                            <p className="text-xs text-yellow-600 dark:text-yellow-400">{t('featureDisabled', language)}</p>
                                 ...
                                 {/* Sync Settings */}
                                <div className="space-y-1">
                                    <p className="text-sm font-medium text-foreground">{t('cloudSync', language)}</p>
                                    {isFirebaseAvailable ? (
                                        <>
                                            <p className="text-xs text-green-600 dark:text-green-400">{t('featureEnabled', language)}</p>
                                        </>
                                        ...
                                        <>
                                            <p className="text-xs text-yellow-600 dark:text-yellow-400">{t('featureDisabled', language)}</p>
                                            <p className="text-xs text-muted-foreground">{t('syncDisabledHint', language)}</p>
                                        </>
                                    )}
                                </div>
                            </div>
